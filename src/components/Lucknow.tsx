...
export default function Lucknow() {
  ...
  // Lucknow पेज के लिए टॉप 4 प्रोफाइल्स (आप चाहें तो यहाँ Lucknow के हिसाब से फ़िल्टर भी लगा सकते हैं)
  ...
  return (
    <div className="overflow-hidden">
      ...
      >
        ...
        <div className="block sm:hidden absolute inset-0 z-0 bg-[#0a0d14]">
          <div className="absolute top-0 left-0 w-full h-[55vh]">
            <img
              src="/Russian call girls dehradun.png" // Lucknow specific image
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6 sm:space-y-8 select-none mt-10 sm:mt-0 py-6 sm:py-12">
          ...
          >
            ...
            <h1 className="font-serif text-3xl sm:text-4.5xl md:text-6.5xl font-extrabold text-white leading-tight tracking-tight drop-shadow-lg">
              Royal Escort Service <br className="hidden sm:block" />
          ...
          >
            Discover royal companionship in Lucknow. Our elegant, sophisticated, and highly educated companions offer unforgettable premium experiences for high-profile clients in the City of Nawabs.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-6">
            ...
            <h2 className="font-serif text-3xl sm:text-4.5xl font-extrabold text-zinc-900 leading-tight">
              Premium Escorts <br />
              <span className="text-amber-600 italic">in Lucknow</span>
            </h2>
            <div className="h-1 w-20 bg-amber-500 rounded-full" />
            
            <div className="font-sans text-sm sm:text-base text-zinc-700 font-light leading-relaxed space-y-4">
              <p>
                Lucknow, known for its rich heritage and Tehzeeb (manners), deserves companionship that matches its royal essence. 
                Whether you are staying at Gomti Nagar's luxury hotels or exploring the heritage sites, we provide high-class female companions.
              </p>
              <p>
                Our Lucknow agency ensures 100% discretion and supplies well-educated, beautiful models for your personal entertainment, corporate events, and dinner dates.
              </p>
            </div>

            <div className="pt-2">
              <Link to="/escorts" className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-amber-700 hover:text-amber-900 transition-colors duration-200 group">
          ...
          <div className="lg:col-span-6">
            <div className="relative rounded-2xl overflow-hidden border border-zinc-200 shadow-2xl aspect-[4/3] bg-zinc-200">
              <img
                src="/Russian call girls dehradun.png"
              ...
              <div className="absolute bottom-6 left-6 text-white">
                <p className="font-serif text-lg font-bold">5-Star Hotel Outcalls in Lucknow</p>
      ...
      {/* 3. Featured Profiles Grid for Lucknow */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16 space-y-4">
            ...
            <p className="font-sans text-sm text-zinc-400 font-light leading-relaxed">
              Dazzling personalities, beautiful styling, and complete devotion ready to meet you in Lucknow.
            </p>
          </div>
      ...
      {/* MODAL SHEET FOR LUCKNOW (Same as Home) */}
      <AnimatePresence>
        {selectedEscort && (
              ...
              <div className="p-6 md:p-8 flex flex-col justify-between h-full">
                ...
                <div className="space-y-6">
                  <div className="space-y-1">
                    <span className="font-sans text-[10px] tracking-widest text-emerald-400 font-bold uppercase">AVAILABLE IN LUCKNOW</span>
                ...
                <div className="grid grid-cols-2 gap-3 mt-6">
                  ...
                  <a href={`https://wa.me/91000000000?text=Hi%20there%2C%20I%20want%20to%20book%20${selectedEscort.name}%20in%20Lucknow`} className="flex items-center justify-center gap-2 bg-[#220810] text-white py-3 rounded-xl border border-luxury-gold/25"><MessageCircle className="w-4 h-4 text-emerald-500" /> WhatsApp</a>
                </div>
              </div>
            </motion.div>
          </div>
